    ...
    def result(self, response):
        ...
        while True:
            for item in self.driver.find_elements('css selector', 'a'):
                try:
                    if item.get_attribute('href').find('istoe.com.br') >= 0 or item.get_attribute('href').find('dinheirorural.com.br') >= 0 or item.get_attribute('href').find('revistamenu.com.br') >= 0 or item.get_attribute('href').find('motorshow.com.br') >= 0 or item.get_attribute('href').find('revistaplaneta.com.br') >= 0 or item.get_attribute('href').find('istoedinheiro.com.br') >= 0:
